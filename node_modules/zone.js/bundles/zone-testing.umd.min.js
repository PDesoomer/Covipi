...
/**
     ...
     */var e={},t="__SEP_TAG__@[native]",n=function n(){this.error=a(),this.timestamp=new Date};function r(){return new Error("STACKTRACE TRACKING")}function i(){try{throw r()}catch(e){return e}}var o=r(),s=i(),a=o.stack?r:s.stack?i:r;function c(e){return e.stack?e.stack.split("\n"):[]}function u(t,n){for(var r=c(n),i=0;i<r.length;i++)e.hasOwnProperty(r[i])||t.push(r[i])}function l(e,n){var r=[n?n.trim():""];if(e)for(var i=(new Date).getTime(),o=0;o<e.length;o++){var s=e[o],a=s.timestamp,c="____________________Elapsed "+(i-a.getTime())+" ms; At: "+a;c=c.replace(/[^\w\d]/g,"_"),r.push(t.replace("__SEP_TAG__",c)),u(r,s.error),i=a.getTime()}return r.join("\n")}function h(){return Error.stackTraceLimit>0}Zone.longStackTraceZoneSpec={name:"long-stack-trace",longStackTraceLimit:10,getLongStackTrace:function(e){if(e){var t=e[Zone.__symbol__("currentTaskTrace")];return t?l(t,e.stack):e.stack}},onScheduleTask:function(e,t,r,i){if(h()){var o=Zone.currentTask,s=o&&o.data&&o.data.__creationTrace__||[];(s=[new n].concat(s)).length>this.longStackTraceLimit&&(s.length=this.longStackTraceLimit),i.data||(i.data={}),"eventTask"===i.type&&(i.data=Object.assign({},i.data)),i.data.__creationTrace__=s}return e.scheduleTask(r,i)},onHandleError:function(e,t,n,r){if(h()){var i=Zone.currentTask||r.task;if(r instanceof Error&&i){var o=l(i.data&&i.data.__creationTrace__,r.stack);try{r.stack=r.longStack=o}catch(e){}}}return e.handleError(n,r)}},function p(){if(h()){var r=[];!function e(t,r){r>0&&(t.push(c((new n).error)),e(t,r-1))}(r,2);for(var i=r[0],o=r[1],s=0;s<i.length;s++)if(-1==(u=i[s]).indexOf("STACKTRACE TRACKING")){var a=u.match(/^\s*at\s+/);if(a){t=a[0]+"__SEP_TAG__ (http://localhost)";break}}for(s=0;s<i.length;s++){var u;if((u=i[s])!==o[s])break;e[u]=!0}}}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("mocha",(function(e,t){var n=e.Mocha;if(void 0!==n){if(void 0===t)throw new Error("Missing Zone.js");var r=t.ProxyZoneSpec,i=t.SyncTestZoneSpec;if(!r)throw new Error("Missing ProxyZoneSpec");if(n.__zone_patch__)throw new Error('"Mocha" has already been patched with "Zone".');n.__zone_patch__=!0;var o,s,a=t.current,c=a.fork(new i("Mocha.describe")),u=null,l=a.fork(new r),h={after:n.after,afterEach:n.afterEach,before:n.before,beforeEach:n.beforeEach,describe:n.describe,it:n.it};e.describe=e.suite=n.describe=function(){return h.describe.apply(this,f(arguments))},e.xdescribe=e.suite.skip=n.describe.skip=function(){return h.describe.skip.apply(this,f(arguments))},e.describe.only=e.suite.only=n.describe.only=function(){return h.describe.only.apply(this,f(arguments))},e.it=e.specify=e.test=n.it=function(){return h.it.apply(this,d(arguments))},e.xit=e.xspecify=n.it.skip=function(){return h.it.skip.apply(this,d(arguments))},e.it.only=e.test.only=n.it.only=function(){return h.it.only.apply(this,d(arguments))},e.after=e.suiteTeardown=n.after=function(){return h.after.apply(this,_(arguments))},e.afterEach=e.teardown=n.afterEach=function(){return h.afterEach.apply(this,d(arguments))},e.before=e.suiteSetup=n.before=function(){return h.before.apply(this,_(arguments))},e.beforeEach=e.setup=n.beforeEach=function(){return h.beforeEach.apply(this,d(arguments))},o=n.Runner.prototype.runTest,s=n.Runner.prototype.run,n.Runner.prototype.runTest=function(e){var n=this;t.current.scheduleMicroTask("mocha.forceTask",(function(){o.call(n,e)}))},n.Runner.prototype.run=function(e){return this.on("test",(function(e){u=a.fork(new r)})),this.on("fail",(function(e,t){var n=u&&u.get("ProxyZoneSpec");if(n&&t)try{t.message+=n.getAndClearPendingTasksInfo()}catch(e){}})),s.call(this,e)}}function p(e,t,n){for(var r=function(r){var i=e[r];"function"==typeof i&&(e[r]=0===i.length?t(i):n(i),e[r].toString=function(){return i.toString()})},i=0;i<e.length;i++)r(i);return e}function f(e){return p(e,(function(e){return function(){return c.run(e,this,arguments)}}))}function d(e){return p(e,(function(e){return function(){return u.run(e,this)}}),(function(e){return function(t){return u.run(e,this,[t])}}))}function _(e){return p(e,(function(e){return function(){return l.run(e,this)}}),(function(e){return function(t){return l.run(e,this,[t])}}))}})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("asynctest",(function(e,t,n){function r(e,n,r,i){var o=t.current,s=t.AsyncTestZoneSpec;if(void 0===s)throw new Error("AsyncTestZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/async-test.js");var a=t.ProxyZoneSpec;if(void 0===a)throw new Error("ProxyZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/proxy.js");var c=a.get();a.assertPresent();var u=t.current.getZoneWith("ProxyZoneSpec"),l=c.getDelegate();return u.parent.run((function(){var e=new s((function(){c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),o.run((function(){r()}))}),(function(t){c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),o.run((function(){i(t)}))}),"test");c.setDelegate(e),e.patchPromiseForTest()})),t.current.runGuarded(e,n)}t[n.symbol("asyncTest")]=function t(n){return e.jasmine?function(e){e||((e=function(){}).fail=function(e){throw e}),r(n,this,e,(function(t){if("string"==typeof t)return e.fail(new Error(t));e.fail(t)}))}:function(){var e=this;return new Promise((function(t,i){r(n,e,t,i)}))}}})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
