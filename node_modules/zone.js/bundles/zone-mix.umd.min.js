...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var ae=l("zoneTask");function ie(e,t,n,r){var o=null,a=null;n+=r;var i={};function s(t){var n=t.data;return n.args[0]=function r(){try{t.invoke.apply(this,arguments)}finally{t.data&&t.data.isPeriodic||("number"==typeof n.handleId?delete i[n.handleId]:n.handleId&&(n.handleId[ae]=null))}},n.handleId=o.apply(e,n.args),t}function c(t){return a.call(e,t.data.handleId)}o=D(e,t+=r,(function(n){return function(o,a){if("function"==typeof a[0]){var l=u(t,a[0],{isPeriodic:"Interval"===r,delay:"Timeout"===r||"Interval"===r?a[1]||0:void 0,args:a},s,c);if(!l)return l;var f=l.data.handleId;return"number"==typeof f?i[f]=l:f&&(f[ae]=l),f&&f.ref&&f.unref&&"function"==typeof f.ref&&"function"==typeof f.unref&&(l.ref=f.ref.bind(f),l.unref=f.unref.bind(f)),"number"==typeof f||f?f:l}return n.apply(e,a)}})),a=D(e,n,(function(t){return function(n,r){var o,a=r[0];"number"==typeof a?o=i[a]:(o=a&&a[ae])||(o=a),o&&"string"==typeof o.type?"notScheduled"!==o.state&&(o.cancelFn&&o.data.isPeriodic||0===o.runCount)&&("number"==typeof a?delete i[a]:a&&(a[ae]=null),o.zone.cancelTask(o)):t.apply(e,r)}}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("node_util",(function(e,t,n){n.patchOnProperties=w,n.patchMethod=D,n.bindArguments=v,n.patchMacroTask=O,function r(e){P=e}(!0)})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
